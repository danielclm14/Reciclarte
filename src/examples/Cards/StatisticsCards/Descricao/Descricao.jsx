...
export default props  => (<div className="corpo">
        ...
        <div className="topbar">
            ...
            <div className='descr'>
                ...
                <h2 className='endereço1'><span>Local:</span> {props.endereco}</h2>
                <h2 className='comprimentoMadeira1'><span>Condição:</span> {props.descricao}</h2> 
                <h2 className='comprimentoMadeira1'><span>Dimensões:</span> {props.comprimento}</h2> 
                <h2 className='tipoMadeira1'><span>Tipo:</span> {props.tipo}</h2>
